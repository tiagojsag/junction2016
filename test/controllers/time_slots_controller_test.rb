...
class TimeSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post time_slots_url, params: { time_slot: { end: @time_slot.end, price: @time_slot.price, start: @time_slot.start } }
    end
  ...
  test "should update time_slot" do
    patch time_slot_url(@time_slot), params: { time_slot: { end: @time_slot.end, price: @time_slot.price, start: @time_slot.start } }
